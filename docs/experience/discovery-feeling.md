...
Maintainer-stated north star (2026-08-01): the VS Code workbench should feel like
**exploring and uncovering hunches**. Anti-goals: never **complex** or **brittle**.
This file locks the emotional jobs and moment beats as experience source of truth;
Get Started should read as workbench guidance, not admin console.
